...
public class MessageUtil {
	 ...
	 * 2、UTF-8编码的 将content 做urlencode编码后，带入encode=utf8或utf-8 http://m.5c.com.cn/api/send/index.php?username=XXX&password_md5=XXX&apikey=XXX&mobile=XXX&content=%E4%BD%A0%E5%A5%BD%E6%89%8D%E6%94%B6%E7%9B%8A%E9%9F%A6&encode=utf8
	 *示例 
	 */
	public static final String sendMessage(String mobile, String content) {
		...
		String username = "18268696744";  //用户名
		
		String password_md5 = "yin1234";  //密码
		
		//手机号,只发一个号码：13800000001。发多个号码：13800000001,13800000002,...N 。使用半角逗号分隔。
		String apikey = "626f94f4e2e27768eb7a24c109686c22";  //apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）
		...
		try {
			...
			buffer.append("http://m.5c.com.cn/api/send/index.php?username="+username+"&password_md5="+MD5Util.getMd5(password_md5)+"&mobile="+mobile+"&apikey="+apikey+"&content="+contentUrlEncode+"&encode="+encode);
	...
	public static void main(String[] args) {
		sendMessage("15002107061", RandomUtil.getDigitString(5));
	}
